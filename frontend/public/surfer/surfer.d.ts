...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h1d5dbf3bd8774d5f: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h7ccda201d7e2eb3f: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h94115e8e07b6aa2a: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h039ae652bd4b5f94: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h039ae652bd4b5f94_2: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h6fbf35f64129760d: (a: number, b: number) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h309f4900858d599a: (a: number, b: number) => void;
